...
2. `agents/instructions/repository-rules.md`
3. The adapter in `agents/tools/` that matches the running tool

The root `AGENTS.md` remains the Codex-style entry point. This `agents/` folder is
